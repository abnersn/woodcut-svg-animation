...
_postAddChecks = function _postAddChecks(timeline, child) {
  ...
  child._start = _round$1((_isNumber$1(position) ? position : position || timeline !== _globalTimeline ? _parsePosition$1(timeline, position, child) : timeline._time) + child._delay);
...
Tween.version = Timeline.version = gsap$1.version = "3.7.0";
_coreReady = 1;
...
async function animate() {
    ...
    const skyTimeline = gsapWithCSS.timeline({
        scrollTrigger: {
            trigger: '.container',
            scroller: '.scroller',
            start: 'top left',
    ...
    const cowTimeline = gsapWithCSS.timeline({
        repeat: -1
    });
    ...
    const chickenTimeline = gsapWithCSS.timeline({
        repeat: -1,
        repeatDelay: 2
    });
    ...
    const idle = gsapWithCSS.timeline({ repeat: -1 });
    idle.to(
        '.donkey #tail',
        {
            rotate: -5,
    ...
    const walk = gsapWithCSS.timeline({
        repeat: 12,
        scrollTrigger: {
            trigger: '.container',
            scroller: '.scroller',
